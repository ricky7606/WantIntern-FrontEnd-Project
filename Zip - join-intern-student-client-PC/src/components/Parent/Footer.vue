  ...
  <div class="wi-footer flex-col">
    <div class="content flex-col">
      ...
      <div class="message flex-row flex-center">
        <a href="#/help/FOOTER_INTRO">关于我们</a>
        <a href="#/help/FOOTER_ENTERPRISE_HELP">企业帮助</a>
        <a href="#/help/FOOTER_STUDENT_HELP">学生帮助</a>
      </div>
      <div class="message flex-row flex-center">
        {{ address }}
      </div>
  ...
  export default {
    ...
    mounted () {
      ...
      MetaProxy.Get('FOOTER_ADDRESS', res => {
        if (res) {
          if (res[0]) this.address = res[0].title
        }
      })
      // MetaProxy.Get('FOOTER_INTRO', res => {
      //   if (res) {
      //     if (res[0]) this.intro = res[0].title
      //   }
      // })
    },
    methods: {
