...
// const BASE_URL = 'http://x.xiangshixi.com:8080/api'
let BASE_URL = `${location.origin}/backend/api`
if (location.host.indexOf('localhost') !== -1) {
  // BASE_URL = 'http://x.xiangshixi.com:8080/api'
...
export const OtherSubUrl = {
  ...
  putOpenIdToAccount (accountId, openid) {
    let relativeUrl = `/accounts/${accountId}/wechat?openid=${openid}`
    return joinUrl(relativeUrl)
  },
  // 登出
