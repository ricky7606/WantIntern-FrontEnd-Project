<template lang="html">
  <div class="date-time-selector">
    <div class="row">
      <!-- 日期：<input type="date" ref="dateSelector" v-model="date" @change="dateChange" @focus="inputingDate = true" @blur="inputingDate = false"/> -->
      日期：
      <div class="col date-picker">
        <datepicker v-model="date" language="zh" :format="'yyyy-MM-dd'"></datepicker>
      </div>
      <!-- <div class="hint-text" v-show="inputingDate && inputDateBroken">日期输入格式:2010-10-10</div> -->
    </div>
    <div class="row">
