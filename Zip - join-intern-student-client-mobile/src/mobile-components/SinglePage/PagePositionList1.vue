    ...
    <div class="content">
      ...
      <div class="list">
        <template v-for="item in list">
          <!-- <div class="list-item" @click="goDetail(item.positionId)"> -->
          <a class="list-item" target="_blank" :href="`#/message/resume/resumeid?id=${item.id}`">
            ...
            <div class="row reqs flex-row flex-between">
              <span>
