          ...
          <div class="list-item">
            <div class="row space-between">
              <div class="left col">
                ...
                <div class="salary col">{{item.position.salary}}{{item.position.unit}}</div>
              </div>
              <div class="right col">
...
<script>
  ...
  const tabbarTitle = [
    ...
    { title: '实习中', tag: [mapResumeState.WORKING, mapResumeState.ENDED], },
    { title: '已结束', tag: [mapResumeState.COMMENTED], },
